...
namespace TeduShop.Web.App_Start
{
    public partial class Startup
    {
        ...
        /// <summary>
        /// Public client Secret property.
        /// </summary>
        public static string PublicClientSecret { get; private set; }
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseOAuthAuthorizationServer(new OAuthAuthorizationServerOptions
            {
                ...
                Provider = new AuthorizationServerProvider(PublicClientId, PublicClientSecret),
